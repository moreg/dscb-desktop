...
8. **语言简洁、准确**：避免过度修辞、空泛抒情和重复强调。每个动作、表情和心理描写都应服务于人设、关系变化或情节推进；若删去后不影响信息、氛围或人物塑造，就不要写。
9. **标点规范**：正文禁用破折号 ——/—、双连字符 --、省略号停顿 ……；改用句号、逗号、短句或动作断句。
10. **改写输出自身不得引入新的 AI 味**：你在改味时禁止把一种 AI 套路换成另一种 AI 套路。改写后不得出现以下高频 AI 表达：
   ...
   - 表情/动作套路：眼中闪过一丝X / 嘴角勾起一抹X / 嘴角勾起一抹弧度 / 眸色一暗 / 眼底闪过一丝 / 抿了抿唇 / 顿了顿 / 停了停 / 愣了愣 / 怔了怔 / 眉头微皱 / 眉眼低垂 / 瞳孔微缩
...
12. **本质洞察**：AI 味的本质不是"写得差"，而是"统计平均感"——均匀、完整、对称。重度改写时优先破坏这三性：让句式不对称、让叙述带主观偏差、让信息不均匀分布（该略处一笔带过，该重处细写）。越想写"有东西"的段落，越要少写。
...
- "心中涌起一股X / 心头一震" → 身体反应（攥紧手/呼吸急促）或具体行为
- "深吸一口气" → 删或换具体呼吸描写
- "不容置疑/显而易见" → 删（判断词）
- "顿了顿 / 停了停 / 愣了愣 / 怔了怔" → 根据具体情境写实际动作（如放下杯子、看向窗外等），或省略动作，用留白和对白体现张力（不要为了表现情绪而机械、频繁套用动作）
...
- 避免整齐划一的“动作＋说话”的死板结构（如 "他皱了皱眉说：'...' "） → 保持句式自然多变，将动作与对话逻辑错开或独立成行
...
- 第一人称同样适用："我心里一阵烦躁" → "我把筷子撂下了"（主语是"我"时不要把 tell 漏过去）
